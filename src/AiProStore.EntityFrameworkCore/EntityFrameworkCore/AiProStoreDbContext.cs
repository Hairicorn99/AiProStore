using AiProStore.Attributes;
using AiProStore.Configurations.Promotions;
using AiProStore.Inventories;
using AiProStore.InventoryTickets;
...
public class AiProStoreDbContext :
    AbpDbContext<AiProStoreDbContext>,
    IIdentityDbContext,
    ITenantManagementDbContext
{
    ...
    public AiProStoreDbContext(DbContextOptions<AiProStoreDbContext> options)
        : base(options)
    {
    ...
    protected override void OnModelCreating(ModelBuilder builder)
    {
        ...
        //{
        //    b.ToTable(AiProStoreConsts.DbTablePrefix + "YourEntities", AiProStoreConsts.DbSchema);
